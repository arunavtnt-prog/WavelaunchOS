...
export async function buildClientContext(clientId: string): Promise<ClientContext> {
  ...
  return {
    client_name: client.creatorName,
    brand_name: client.brandName || client.creatorName,
    email: client.email,
    niche: client.niche || client.targetIndustry,
    vision_statement: client.visionStatement,
    ...
    social_handles: client.socialHandles || undefined,
