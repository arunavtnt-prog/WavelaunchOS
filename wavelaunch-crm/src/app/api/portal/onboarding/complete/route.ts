    ...
    const updatedClient = await prisma.$transaction(async (tx) => {
      ...
      const client = await tx.client.update({
        ...
        data: {
          ...
          ...(data.competitiveDifferentiation && { differentiation: data.competitiveDifferentiation }),
