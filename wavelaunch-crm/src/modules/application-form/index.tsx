...
import { StepCareerBackground } from './components/step-career'
import { StepAudienceDemographics } from './components/step-audience'
import { StepPainPoints } from './components/step-pain-points'
import { StepCompetition } from './components/step-competition'
import { StepBrandIdentity } from './components/step-brand-identity'
import { StepProductDirection } from './components/step-product'
import { StepBusinessGoals } from './components/step-business-goals'
import { StepLogistics } from './components/step-logistics'

export function ApplicationFormRoot() {
